...
impl VideoRepo {
    ...
    pub async fn list_all(db: &DatabaseConnection) -> Result<Vec<videos::Model>, AppError> {
    ...
    /// Get by ID.
    pub async fn get_by_id(db: &DatabaseConnection, id: Uuid) -> Result<Option<videos::Model>, AppError> {
